...
class _BatchAnimeScreenState extends State<BatchAnimeScreen> {
  ...
  void initState() {
    super.initState();
    context
        .read<GetBatchAnimeCubit>()
        .fetchBatchAnime(id: widget.data.batchLink.id);
  }
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ExpansionTile(
                            ...
                            children:
                                _data.downloadList.lowQuality.downloadLinks
                                    .map((e) => ListTile(
                                          title: Text(e.host),
                        ...
                        Container(
                          ...
                          child: ExpansionTile(
                            title:
                                Text(_data.downloadList.mediumQuality.quality),
                            subtitle:
                                Text(_data.downloadList.mediumQuality.size),
                            children:
                                _data.downloadList.mediumQuality.downloadLinks
                                    .map((e) => ListTile(
                                          title: Text(e.host),
                                          trailing: Icon(Icons.file_download),
                                          onTap: () async {
                        ...
                        Container(
                          ...
                          child: ExpansionTile(
                            ...
                            children:
                                _data.downloadList.highQuality.downloadLinks
                                    .map((e) => ListTile(
                                          title: Text(e.host),
                                          trailing: Icon(Icons.file_download),
                                          onTap: () async {
